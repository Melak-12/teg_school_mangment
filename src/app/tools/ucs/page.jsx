    ...
    <div className='p-6 '>
      ...
      <div className='flex flex-row justify-between p-10'>
        ...
        <div className='flex justify-end'>
          <button className='bg-blue-600 text-blue-50 rounded-full px-6 p-2'>
            add course
          </button>
        </div>
      </div>
            ...
            <div className='flex flex-wrap  flex-row  '>
              <div className='flex flex-col '>
                <div className='flex p-1 gap-2 justify-center  flex-wrap flex-row bg-white rounded-md '>
                  ...
                  <div className='flex flex-row flex-wrap gap-6 w-full overflow-y-scroll h-5/6 justify-around -mt-20'>
                ...
                <div className='flex flex-col  gap-10 p-8 w-full'>
                  ...
                  <div className='flex flex-col  text-slate-500'>
                    <p>
                      ...
                      jumped over the lazy dog . well that was not as long as i
                      had hoped
                    </p>
                  </div>
                  <div className='-mt-5'>
                    <Image src='/book1.jpeg' alt='' width={290} height={150} />
                  </div>
                </div>
